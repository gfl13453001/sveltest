...
if sys.platform == "win32" or sys.platform != "Linux":
    v = "sveltest@Windows 1.0  win32_x86\nUpdateTime:20220926\n version 1.0.0"
else:
    v = "sveltest@Linux 1.0  Linux32 \nUpdateTime:20220926\n version 1.0.0"
...
def main():
    ...
    try:
        ...
        if args.create == "create":
            ...
            # if args.ui == "-ui" :
            if args.ui:
                path_join = r"%s\%s".replace("\\","/") % (current_path, args.ui)
        ...
        # v 1.2.1
            ...
            os.system("start http://tank.zhank.top:8022/")
